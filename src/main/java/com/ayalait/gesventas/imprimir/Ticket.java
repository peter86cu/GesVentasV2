...
public class Ticket {
    ...
    public static void AddTotal(String name,String price){
        OrdenTotal newTotal = new OrdenTotal(' ');
    ...
    public static void ImprimirDocumento(String impresora,boolean abrir){
         try{
        	 ...
        	 File ftest = new File(impresora);
             FileWriter imp = new FileWriter(ftest);
